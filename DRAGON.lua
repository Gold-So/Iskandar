...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝒅𝒆𝒎𝒐𝒏', url="t.me/alexaandeer1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == 'ديمون' or text == 'مطور السورس' or text == 'الشيطان' then
local Text = [[
مطور سورس ديمون لو حباب تتوصل معها اتبع الزرار الي تحت
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒅𝒆𝒎𝒐𝒏',url="t.me/Dad_elShitan"}},
...
' }\n'..' ⌯︙  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ⌯︙  الرفع  ⇇{ '..setadd..
' }\n'..' ⌯︙  الحظر  ⇇{ '..banm..' }\n\n ⌯︙═───═❲[𝒅𝒆𝒎𝒐𝒏 ](t.me/alexaandeer1)❳═───═ ⌯︙\n ⌯︙ قناة سورس ديمون•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•\n [ ❲[𝒅𝒆𝒎𝒐𝒏 ](t.me/alexaandeer1)❳](t.me/alexaandeer1) \n'
send(msg.chat_id_, msg.id_,text)     
end
