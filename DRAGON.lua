...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━• :\na•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•\n\27')
local token = io.read()
if token ~= '' then
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━• :\na•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•\n\27[0;33;49m')
...
io.write('\27[1;31m •━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,1743756832,1903411846,1751768178,1304868679,1614314857,}   
...
var = 'البوت'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'المطور الفاجر'  
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'صاحب الخرابه يواد'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
var = database:get(bot_id.."BasicConstructor:Rd"..msg.chat_id_) or 'المنشئ اساسي روح قلبي'
elseif database:sismember(bot_id..'Constructor'..chat_id, user_id) then
var = database:get(bot_id.."Constructor:Rd"..msg.chat_id_) or 'المنشئ حته من قلبي'  
...
var = 'منظف' 
elseif database:sismember(bot_id..'Mod:User'..chat_id, user_id) then
var = database:get(bot_id.."Mod:Rd"..msg.chat_id_) or 'الادمن نين عيني'  
elseif database:sismember(bot_id..'Special:User'..chat_id, user_id) then  
var = database:get(bot_id.."Special:Rd"..msg.chat_id_) or 'المميز حبيبي الكل'  
else  
var = database:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'العضو القامد'
end  
return var
end 
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'جولد') 
local DRAGON_Msg = { 
' ♟┊‌‎اهلا انا بوت اسمي '..Namebot..' ✓.\n♟┊‌‎اختصاصي حمايه المجموعات\n♟┊‌‎لتفعيل البوت اتبع الخطوات التاليه\n♟┊‌‎اضف البوت الي مجموعتك\n♟┊‌‎ارفعه مشرف في الجروب\n♟┊‌‎ارسل كلمة تفعيل ليتم تفعيل البوت',
} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '😍مطور السورس',url="t.me/DEV_AH8"}}, 
...
local Text = ' ⌯︙تم ارسال الملصق من •━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•\n - '..Name
...
if text == 'تحكم الاذاعه' and DevSoFi(msg) then 
...
send(msg.chat_id_, msg.id_,' ⌯︙ اصدار سورس جولد{ 3x☆}')
end
if text == '•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•' and DevSoFi(msg) then
local Text = [[ 
...
if text == "خنلنلنفن" and SudoBot(msg) or text == 'تبنبزب' and SudoBot(msg) then 
if not DevSoFi(msg) then
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "جولد")
...
local Text = [[
مالك السورس لو حباب تتواصل معاه اتبع الزر الي تحت👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙏𝙄𝙂𝙀𝙍',url="t.me/Dev_RE4"}},
{{text = '𝔰𝔬𝔲𝔯𝔠𝔢 ', url="t.me/g_00_l_d"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dev_RE4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == '━┅┅┄⟞⟦ مطورين السورس⟧⟝┄┉┉━' or text == 'نبنبزلن' or text == 'نبهلزلز' then
local Text = [[
مطورين + مبرمجين السورس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫𝐬 𝐆𝐨𝐥𝐝 ⌯ ',url="t.me/dv_gold"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
"لو خيروك |  بين تناول البيتزا وبين الآيس جولد وذلك بشكل دائم؟ ",
...
"لو خيروك |  بين تنظيف شعرك بسائل غسيل الأطباق وبين استخدام جولد الأساس لغسيل الأطباق؟ ",
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯ 𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯', url="t.me/g_00_l_d"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
{
{text = 'sᴏᴜʀᴄᴇ ɢᴏʟᴅ', url="t.me/g_00_l_d"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if tonumber(result.sender_user_id_) == tonumber(1304868679) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1304868679) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1304868679) then  
send(msg.chat_id_, msg.id_, " ⌯︙ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
t = ' ⌯︙ ملفات السورس جولد•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•\n •━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━• \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if text == ("مسح قائمه جولد") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⌯︙ تم مسح قائمه جولد')
return false
end

if text == 'قائمه جولد' and Sudo(msg) then
...
if text == ("رفع جولد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع جولد@(.*)$") and Sudo(msg) then
local username = text:match("^رفع جولد@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع جولد(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع جولد(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل جولد") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل جولد@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل جولد@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل جولد(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل جولد(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
'\n❲[ɢᴏʟᴅ ](t.me/g_00_l_d)❳'..
'\n•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•'..
'\n ⌯︙ اعدادات الجروب كتالي ☆•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•'..
'\nء•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•'..
'\n ⌯︙  علامة ال {✓} تعني مفعل'..
'\n ⌯︙  علامة ال {✘} تعني معطل'..
'\nء•━═━═『⌯︙ 𝙏𝙀??𝙈 ɢᴏʟᴅ ⌯︙』═━═━•'..
...
send(msg.chat_id_, msg.id_, t..'•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•\nاضغط علي الاسم ليتم نسخه\n•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•ٴ\n ⌯︙ [sᴏᴜʀᴄᴇ ɢᴏʟᴅ ](t.me/g_00_l_d)⌯︙ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'جولد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'جولد')
local Dev_Ah8 = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
end --الكود حصري سورس جولديعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'جولد').." غادر" or text == 'غادر' then  
...
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"رتبتك ف البوت⇇"..Rutba(msg.sender_user_id_,msg.chat_id_).." . ", msg.id_, msg.id_, "md")
else
...
[[
🌨•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•Use ⇨ #username 🌨
🌨•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•iD ⇨ #id 🌨
🌨•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•Sta ⇨  #stast 🌨
🌨•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•Msg ⇨ #msgs 🌨
🌨•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•𝙐𝙎𝙀𝙍𝙉𝘼𝙈?? ➱ #username ⌯︙  
↑•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•𝙄𝘿 ➱ #id
↑•━═━═『⌯︙ 𝘼𝙇𝙀𝙓𝘼𝙉𝘿𝙀?? ⌯︙』═━═━•𝙍𝘼𝙉𝙆 ➱  #stast ⌯︙  
↑•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•𝙈𝘼𝙎𝙂 ➱ #msgs ⌯︙  
↑•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•𝗖𝗛 ➯  ↝@g_00_l_d↜ ⌯︙  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
𝟓 𝟔 𖡻 #msgs  ࿇🦄
...
keyboard.inline_keyboard = {
{
{text = 'م1', callback_data="/help1"},{text = 'م2', callback_data="/help7"},
},
{
{text = 'م3', callback_data="/help6"},
},
{
{text = 'م4', callback_data="/help2"},,{text = 'م5', callback_data="/help5"},
},
{
{text = 'sᴏᴜʀᴄᴇ ɢᴏʟᴅ', url="t.me/g_00_l_d"},
},
...
local Text = [[
 ...
 تحت لي في الزر الأسفل•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•
...
{
{text = 'م3', callback_data="/help6"},{text = 'م5', callback_data="/help5"},
},
{
{text = 'م4', callback_data="/help2"},
},
{
{text = 'sᴏᴜʀᴄᴇ ɢᴏʟᴅ', url="t.me/g_00_l_d"},
},
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•
 اختر الامر الذي تريدها .↑•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•
ده من الازرار بلاسفل . •━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [sᴏᴜʀᴄᴇ ɢᴏʟᴅ ](t.me/g_00_l_d)
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•
 اختر العبه الذي تريدها .↑•━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•
ده من الازرار بلاسفل . •━═━═『𝗦𝗼𝘂𝗿𝗰𝗲 𝗚𝗼𝗹𝗱』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 [sᴏᴜʀᴄᴇ ɢᴏʟᴅ ](t.me/g_00_l_d)
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'جولد')
...
"‏صراحه  |  من هو الشخص الذي يأتي في قلبك بعد الله – سبحانه وتعالى- ورسوله الجولد – صلى الله عليه وسلم؟",
