...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━• :\na•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━• :\na•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•\n\27[0;33;49m')
...
io.write('\27[1;31m •━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐌𝐎𝐍',url="t.me/Dad_elShitan"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = ' ⌯︙تم ارسال الملصق من •━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•\n - '..Name
...
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐄𝐌𝐎𝐍', url="t.me/alexaandeer1"}},
}
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ᴰᴱᴹᴼᴺ', url="t.me/alexaandeer1"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
if text == '•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ديمون ادخل وتابع الجديد](t.me/alexaandeer1)
]] 
keyboard = {}  
...
local Text = [[ 
╭━━━❲☆[𝚍𝚎𝚖𝚘𝚗](t.me/alexaandeer1)☆❳━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙴𝙰𝙼 𝚍𝚎𝚖𝚘𝚗 ](t.me/alexaandeer1)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/alexaandeer1)
╰━━━❲☆[𝚍𝚎𝚖𝚘𝚗](t.me/alexaandeer1)☆❳━━━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = '𝐄𝐋𝐒𝐇𝐈𝐓𝐀𝐍',url="t.me/Dad_elShitan"}},
{{text = '𝐁𝐀𝐑𝐋𝐎𝐎',url="t.me/bar_lo0o0"}},
{{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐄𝐌𝐎𝐍', url="t.me/alexaandeer1"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5 
...
if database:get(DRAGON.."Cick:Del:Me"..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1,  ⌁︙عذرا هذه الخاصيه معطله  , 1,  md )
return false
end
database:set(DRAGON.. yesdel ..msg.sender_user_id_,  delyes )
database:set(DRAGON.. nodel ..msg.sender_user_id_,  delno )
...
--     Source DRAGON     --
if text ==  "تعطيل نزلني"  and ChCheck(msg) and ChCheck(msg) then
database:set(DRAGON.."Cick:Del:Me"..msg.chat_id_, true)
local DRAGONTEAM =  ⌁︙اهلا عزيزي ↫  ..CickRank(msg)..  \n⌁︙تم تعطيل امر نزلني 
send(msg.chat_id_, msg.sender_user_id_, msg.id_, DRAGONTEAM, 14, string.len(msg.sender_user_id_))
end
if text ==  "تفعيل نزلني"  and ChCheck(msg) and ChCheck(msg) then
database:del(DRAGON.."Cick:Del:Me"..msg.chat_id_)
local DRAGONTEAM =  ⌁︙اهلا عزيزي ↫  ..CickRank(msg)..  \n⌁︙تم تفعيل امر نزلني 
send(msg.chat_id_, msg.sender_user_id_, msg.id_, DRAGONTEAM, 14, string.len(msg.sender_user_id_))
end

if text == 'الشيطان' or text == 'داد الشيطان' or text == 'مطورالسورس' then
local Text = [[
الشيطان مبرمج سورس ديمون لو حابب تتواصل دوس علي الزر الي تحت 👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐄𝐋𝐒𝐇𝐈𝐓𝐀𝐍',url="t.me/Dad_elShitan"}},
{{text = '𝔰𝔬𝔲𝔯𝔠𝔢', url="t.me/alexaandeer1"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dad_elShitan&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'بارلو' or text == 'مبرمج السورس2' or text == 'هكر السورس' then
local Text = [[
مبرمج السورس2
]]
keyboard = {} 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/bar_lo0o0&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ᴰᴱᴹᴼᴺ',url="t.me/Dad_elShitan"}},
{{text = 'قناه السورس',url="t.me/alexaandeer1"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐃𝐄𝐌𝐎𝐍', url="t.me/alexaandeer1"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/alexaandeer1)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local admins = data.members_
for i=0 , #admins do
if data.members_i].status_.ID == "ChatMemberStatusCreator" then
...
' }\n'..' ⌯︙  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ⌯︙  الرفع  ⇇{ '..setadd..
' }\n'..' ⌯︙  الحظر  ⇇{ '..banm..' }\n\n ⌯︙═───═❲[ᴰᴱᴹᴼᴺ ](t.me/alexaandeer1)❳═───═ ⌯︙\n ⌯︙ قناة سورس ديمون•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•\n [ ❲[ᴰᴱᴹᴼᴺ ](t.me/alexaandeer1)❳](t.me/alexaandeer1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•\nاضغط علي الاسم ليتم نسخه\n•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•ٴ\n ⌯︙ ❲[ᴰᴱᴹᴼᴺ ](t.me/alexaandeer1)❳ ⌯︙ ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝐒》𝐃𝐄𝐌𝐎𝐍', url="t.me/alexaandeer1"}},
}
local msg_id = msg.id_/2097152/0.5
...
[[
↑•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•𝙐𝙎𝙀𝙍𝙉𝘼𝙈𝙀 ➱ #username ⌯︙  
↑•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•𝙄𝘿 ➱ #id
↑•━═━═『⌯︙ 𝘼𝙇𝙀𝙓𝘼𝙉𝘿𝙀?? ⌯︙』═━═━•𝙍𝘼𝙉𝙆 ➱  #stast ⌯︙  
↑•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•𝙈𝘼𝙎𝙂 ➱ #msgs ⌯︙  
↑•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•𝗖𝗛 ➯  ↝@alexaandeer1↜ ⌯︙  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
𝟓 𝟔 𖡻 #msgs  ࿇🦄
...
local Text =[[
🚨 اهلا بك في قسم الاوامر ..↑•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•
 اختر الامر الذي تريدها .↑•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•
ده من الازرار بلاسفل . •━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[ᴰᴱᴹᴼᴺ ](t.me/alexaandeer1)❳ 
]]
keyboard = {} 
...
local Text = [[
🎮 اهلا بك في قسم الالعاب ..↑•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•
 اختر العبه الذي تريدها .↑•━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•
ده من الازرار بلاسفل . •━═━═『⌯︙ 𝐃𝐄𝐌𝐎𝐍 ⌯︙』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[ᴰᴱᴹᴼᴺ ](t.me/alexaandeer1)❳ 
]]
